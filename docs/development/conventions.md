...
The `documents/` directory contains detailed technical documentation:

- **ARCHITECTURE.md**: Comprehensive system architecture and design patterns
- **SCHEMA.md**: Data storage schemas and message bus event definitions
- **FORWARD_PROGRESS.md**: Idempotency, retry, and error handling patterns
- **SERVICE_MONITORING.md**: Observability, metrics, and logging patterns
- **FAILED_QUEUE_OPERATIONS.md**: Failed queue management and troubleshooting
- **Configuration and migration guides**: CONFIGURATION_MIGRATION.md, SCHEMA_VERSIONING.md, etc.
- **Testing guides**: TESTING_MESSAGE_BUS.md, CI_COVERAGE_STRATEGY.md, etc.
