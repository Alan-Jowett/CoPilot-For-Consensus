...
- Schemas: ✅ [docs/schemas/README.md](schemas/README.md) and [docs/schemas/schema-versioning.md](schemas/schema-versioning.md) point to [docs/schemas](../docs/schemas) JSON until versioned docs are written.
