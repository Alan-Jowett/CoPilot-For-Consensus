...
- [docs/architecture/overview.md](../architecture/overview.md): System architecture and service interactions
- [documents/SERVICE_MONITORING.md](../../documents/SERVICE_MONITORING.md): Monitoring and observability
