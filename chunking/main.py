...
def main():
    ...
    try:
        ...
        error_reporter_type = getattr(config, "error_reporter_type", "console")
        logger.info(f"Creating error reporter ({error_reporter_type})...")
        error_reporter = create_error_reporter(
            driver_name=error_reporter_type
        )
