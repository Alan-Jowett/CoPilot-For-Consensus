...
The Chunking Service subscribes to the following events. See [SCHEMA.md](../docs/schemas/data-storage.md#message-bus-event-schemas) for complete event schemas.
...
The Chunking Service publishes the following events. See [SCHEMA.md](../docs/schemas/data-storage.md#message-bus-event-schemas) for complete event schemas.
...
See [ChunkingFailed schema](../docs/schemas/data-storage.md#6-chunkingfailed) in SCHEMA.md for the complete payload definition.
