...
class TestChunkingForwardProgress:
    ...
    def test_requeue_messages_without_chunks_on_startup(self, mock_requeue_class, chunking_service, mock_document_store, mock_publisher, mock_metrics_collector):
    ...
    @patch('copilot_startup.StartupRequeue')
    def test_requeue_continues_on_import_error(self, mock_requeue_class, chunking_service, mock_subscriber, mock_document_store):
    ...
    @patch('copilot_startup.StartupRequeue')
    def test_requeue_handles_missing_aggregation_support(self, mock_requeue_class, chunking_service, mock_document_store):
    ...
    @patch('copilot_startup.StartupRequeue')
    def test_requeue_emits_metrics(self, mock_requeue_class, chunking_service, mock_document_store, mock_metrics_collector):
    ...
    @patch('copilot_startup.StartupRequeue')
    def test_requeue_continues_on_individual_publish_failure(self, mock_requeue_class, chunking_service, mock_document_store):
