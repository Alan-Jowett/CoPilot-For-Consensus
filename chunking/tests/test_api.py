...
"""Integration tests for the chunking service API."""
...
@pytest.fixture
def test_service(mock_document_store, mock_publisher, mock_subscriber, mock_chunker):
    """Create a test chunking service instance."""
...
def client(test_service, monkeypatch):
    ...
    monkeypatch.setattr(main, "chunking_service", test_service)
...
def test_readyz_endpoint_service_not_initialized(client, monkeypatch):
    ...
    # Set service to None
    monkeypatch.setattr(main, "chunking_service", None)
