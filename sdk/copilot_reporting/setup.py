...
long_description = readme_path.read_text(encoding="utf-8") if readme_path.exists() else "Shared error reporting library for Copilot-for-Consensus microservices"
