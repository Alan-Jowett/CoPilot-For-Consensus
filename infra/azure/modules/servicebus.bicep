...
// IMPORTANT: When at least one custom rule is defined during subscription creation,
// Azure Service Bus does NOT auto-create the $Default TrueFilter rule.
// We use a custom rule name to ensure proper deployment.
