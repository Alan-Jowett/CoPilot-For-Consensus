...
"""Setup configuration for copilot-message-bus package."""
...
if readme_path.exists():
    ...
    long_description = "Shared message bus library for Copilot-for-Consensus microservices"

setup(
    name="copilot-message-bus",
    version="0.1.0",
    author="Copilot-for-Consensus Contributors",
    description="Shared message bus publishing and subscribing library for Copilot-for-Consensus microservices",
