...
setup(
    ...
    install_requires=[
        "copilot-config>=0.1.0",  # For generated typed adapter configs + adapter factory
        "pymongo>=4.6.3",  # MongoDB client
        "azure-cosmos>=4.9.0,<4.15.0",  # Azure Cosmos DB client - pinned <4.14 due to partition_key bug in 4.14.x (Issue #43662)
