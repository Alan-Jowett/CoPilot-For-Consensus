...
class TestDatatrackerDiffProvider:
    ...
    def test_initialization_default(self):
        ...
        provider = DatatrackerDiffProvider(base_url="https://datatracker.ietf.org", diff_format="html")
    ...
    def test_initialization_custom_url(self):
        ...
        provider = DatatrackerDiffProvider(base_url="https://custom.example.com", diff_format="html")

        assert provider.base_url == "https://custom.example.com"

    def test_initialization_strips_trailing_slash(self):
        """Test that trailing slash is stripped from base URL."""
        provider = DatatrackerDiffProvider(base_url="https://example.com/", diff_format="html")
    ...
    def test_initialization_custom_format(self):
        ...
        provider = DatatrackerDiffProvider(base_url="https://datatracker.ietf.org", diff_format="text")
