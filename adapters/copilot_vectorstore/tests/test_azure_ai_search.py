...
class TestAzureAISearchVectorStore:
    ...
    def test_managed_identity_with_client_id(
        self, mock_credential_class, mock_index_client_class, mock_search_client_class
    ):
    ...
    @patch("azure.search.documents.indexes.SearchIndexClient")
    @patch("azure.identity.DefaultAzureCredential")
    def test_managed_identity_without_client_id(
        self, mock_credential_class, mock_index_client_class, mock_search_client_class
    ):
