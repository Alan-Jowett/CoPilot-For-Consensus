...
bootstrap_logger = create_logger("stdout", {"level": "INFO", "name": "parsing-bootstrap"})
...
def main():
    ...
    try:
        ...
        subscriber_driver_config.setdefault("queue_name", "archive.ingested")
        ...
        try:
            ...
            if metrics_adapter is not None:
                ...
                metrics_driver_config.setdefault("job", "parsing")
