...
def get_reports(
    ...
    start_date: str = Query(None, description="[DEPRECATED] Filter reports generated after this date (ISO 8601). Use message_start_date instead."),
    end_date: str = Query(None, description="[DEPRECATED] Filter reports generated before this date (ISO 8601). Use message_end_date instead."),
