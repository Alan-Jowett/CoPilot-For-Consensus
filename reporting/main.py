...
logger = create_logger("stdout", {"level": "INFO", "name": "reporting"})
...
def main():
    ...
    try:
        ...
        document_store = create_document_store(
            ...
            driver_config=dict(document_store_adapter.driver_config.config),
            enable_validation=True,
            strict_validation=True,
        )
        ...
        try:
            ...
            if metrics_adapter is not None:
                ...
                metrics_driver_config.setdefault("job", "reporting")
        ...
        if vector_store_adapter is not None and embedding_adapter is not None:
            try:
                ...
                embedding_provider = create_embedding_provider(
                    ...
                    driver_config=dict(embedding_adapter.driver_config.config),
                )
                ...
                vector_store_config = dict(vector_store_adapter.driver_config.config)
                vector_store_config.setdefault("dimension", embedding_dimension)
                vector_store = create_vector_store(
                    driver_name=vector_store_adapter.driver_name,
                    driver_config=vector_store_config,
                )
