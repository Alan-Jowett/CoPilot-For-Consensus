...
The Reporting Service subscribes to the following events. See [message-schemas.md](../docs/schemas/message-schemas.md#message-bus-event-schemas) for complete event schemas.
...
The Reporting Service publishes the following events. See [message-schemas.md](../docs/schemas/message-schemas.md#message-bus-event-schemas) for complete event schemas.

1) **ReportPublished**
   - **Exchange:** `copilot.events`
   - **Routing Key:** `report.published`
   - See [ReportPublished schema](../docs/schemas/message-schemas.md#13-reportpublished) in message-schemas.md
...
2) **ReportDeliveryFailed** *(optional)*
   ...
   - See [ReportDeliveryFailed schema](../docs/schemas/message-schemas.md#14-reportdeliveryfailed) in message-schemas.md
