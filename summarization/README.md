...
The Summarization Service subscribes to the following events. See [message-schemas.md](../docs/schemas/message-schemas.md#message-bus-event-schemas) for complete event schemas.
...
The Summarization Service publishes the following events. See [message-schemas.md](../docs/schemas/message-schemas.md#message-bus-event-schemas) for complete event schemas.
...
2) **SummarizationFailed**
   ...
   - See [SummarizationFailed schema](../docs/schemas/message-schemas.md#12-summarizationfailed) in message-schemas.md
