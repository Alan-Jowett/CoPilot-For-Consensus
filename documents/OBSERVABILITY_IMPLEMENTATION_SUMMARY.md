...
1. **Adding Metrics to Service**:
   - Read `documents/METRICS_INTEGRATION_GUIDE.md`
...
- **Metrics Integration**: `documents/METRICS_INTEGRATION_GUIDE.md`
- **Service Monitoring**: `documents/SERVICE_MONITORING.md`
- **Alert Rules**: `infra/prometheus/alerts/*.yml`
- **Runbooks**: `documents/runbooks/*.md`
