...
bootstrap_logger = create_logger("stdout", {"level": "INFO", "name": "ingestion-bootstrap"})
...
def main():
    ...
    try:
        ...
        # Create service logger with default settings (log_type and log_level from bootstrap)
        service_logger = create_logger("stdout", {"level": "INFO", "name": "ingestion"})
